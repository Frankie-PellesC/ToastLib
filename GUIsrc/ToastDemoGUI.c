...
const wchar_t wszToastXaml[] =
		...
		L"			<text>This is a sample toast notification from a  plain C app.</text>\r\n"
		L"		<text>Do you love animals?</text>\r\n"
		L"		</binding>\r\n"
		L"	</visual>\r\n"
		L"	<actions>\r\n"
		L"		<input id=\"Animals\" type=\"selection\" defaultInput=\"I love dogs too\">\r\n"
		L"			<selection id=\"I love dogs too\" content=\"I love dogs\"/>\r\n"
		L"			<selection id=\"I_love_cats_too\" content=\"I love cats\"/>\r\n"
		L"			<selection id=\"You're_the_Grouchy_smurf?\" content=\"I haaate animals\"/>\r\n"
		L"		</input>\r\n"
		L"<action content=\"Send Selection\" activationType=\"foreground\" arguments=\"sendSelection\" hint-inputId=\"Animals\"/>\r\n"
